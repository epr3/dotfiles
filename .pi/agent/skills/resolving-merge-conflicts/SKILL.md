...
description: Use when you need to resolve an in-progress git merge/rebase conflict in the code repo. (Context-store merges have their own skills — merge-context / rebase-context.)
---
