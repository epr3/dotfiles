---
name: triage
description: "Move issues through a small state machine of triage roles: categorise, verify, grill if needed, write agent-ready briefs. Requires a tracker + triage labels configured by setup-context."
