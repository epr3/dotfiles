...
- **branch -> trunk (reconcile)**: plain `git merge` combines the files mechanically; run this skill on the merged trunk worktree afterwards to interview the diverging terms.
