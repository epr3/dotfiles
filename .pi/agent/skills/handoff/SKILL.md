...
Write a handoff document for a fresh agent to continue the work. Save to the OS temp dir, not the workspace. Arguments name the next session's focus — tailor to them.
