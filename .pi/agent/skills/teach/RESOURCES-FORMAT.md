...
Curated trusted sources. Knowledge for lessons comes from here, not parametric guesses; wisdom from the communities listed.
...
- [Book: _Title_ by Author](url)
  One line: what it covers. Use for: {when to reach for it}.

## Wisdom (Communities)

- [r/example](url)
  High-signal, well-moderated. Use for: {what to take there}.
- Local: Tuesday class at {place}
